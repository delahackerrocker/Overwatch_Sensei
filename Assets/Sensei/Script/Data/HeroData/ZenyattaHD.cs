...
public class ZenyattaHD : HeroData
{
    public ZenyattaHD() : base()
    {
        ...
        abilities[aCount].abilityDescription = "Energy projectile weapon.";
        ...
        abilities[aCount].abilityName = "ORB OF DESTRUCTION";
        abilities[aCount].abilityDescription = "Charge to release more projectiles.";
        abilities[aCount].abilityIcon = "Heroes/AbilityIcons/" + hero + "/OrbOfDestruction";
        abilities[aCount].abilityVideo = hero + "/ability-orb-of-destruction";
        ...
        abilities[aCount].abilityDescription = "Launch this orb at an ally to heal them.";
        ...
        abilities[aCount].abilityDescription = "Launch this orb at an enemy to increase the damage they take.";
        ...
        abilities[aCount].abilityDescription = "Become invulnerable, move faster, and heal nearby allies.";
