...
public class WreckingBallHD : HeroData
{
    public WreckingBallHD() : base()
    {
        ...
        abilities[aCount].abilityDetail = "Automatic assault weapons.";
        ...
        abilities[aCount].abilityDetail = "Transform into a ball and increase maximum movement speed.";
        ...
        abilities[aCount].abilityDetail = "Create temporary personal shields. Amount increases with more enemies nearby.";
        ...
        abilities[aCount].abilityDetail = "Launch a grappling claw to rapidly swing around the area. Enables high speed collisions to damage and knockback enemies.";
        ...
        abilities[aCount].abilityDetail = "Deploy a massive field of proximity mines.";
