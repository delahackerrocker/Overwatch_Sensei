...
public class JunkratHD : HeroData
{
    public JunkratHD() : base()
    {
        ...
        abilities[aCount].abilityDescription = "Bouncing explosive projectile weapon.";
        ...
        abilities[aCount].abilityDescription = "Throw a knockback mine with LSHIFT then detonate it with ABILITY 1.";
        ...
        abilities[aCount].abilityDescription = "Place an immobilizing trap.";
        ...
        abilities[aCount].abilityDescription = "Drive and detonate an exploding tire.";
        ...
        abilities[aCount].abilityDescription = "Deals no damage to self with explosives. Drop bombs on death.";
