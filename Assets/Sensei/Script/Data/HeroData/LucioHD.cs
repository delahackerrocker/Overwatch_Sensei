...
public class LucioHD : HeroData
{
    public LucioHD() : base()
    {
        ...
        abilities[aCount].abilityDetails[++bCount] = "\nGives Lúcio and all allies in his line of sight a huge burst of temporary shields that immediately decay at 125 shields per second (12 shields every 0.096 s).";
