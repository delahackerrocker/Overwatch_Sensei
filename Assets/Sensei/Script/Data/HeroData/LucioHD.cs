...
public class LucioHD : HeroData
{
    public LucioHD() : base()
    {
        ...
        abilities[aCount].abilityDetail = "Sonic projectile launcher.";
        ...
        abilities[aCount].burst = 4;
        abilities[aCount].pellets = 1;
        abilities[aCount].ammo = 20;
        abilities[aCount].range = 10;
        abilities[aCount].reloadTime = 1.5f;
        abilities[aCount].recoverTime = 0.935f;

        abilities[++aCount] = new AbilityData();
        abilities[aCount].abilityName = "SOUNDWAVE";
        abilities[aCount].abilityDetail = "Create a short-range blast wave to knock enemies away from you.";
        ...
        abilities[aCount].abilityDetail = "Increase the effectiveness of your current song.";
        ...
        abilities[aCount].abilityDetail = "Switches between two songs: Healing Boost heals nearby allies, and Speed Boost makes nearby allies move faster.";
        ...
        abilities[aCount].abilityDetail = "Create temporary shields for nearby allies.";
        ...
        abilities[aCount].abilityDetail = "Jump onto a wall to ride along it.";
