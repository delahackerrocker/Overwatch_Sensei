...
public class TorbjornHD : HeroData
{
    public TorbjornHD() : base()
    {
        ...
        abilities[aCount].abilityDescription = "Inaccurate but powerful short-range weapon.";
        abilities[aCount].abilityIcon = "Heroes/AbilityIcons/" + hero + "/RivetGun";
        abilities[aCount].abilityVideo = hero + "/ability-rivet-gun";
        ...
        abilities[aCount].abilityDescription = "Swing to repair your turret or damage an enemy.";
        ...
        abilities[aCount].abilityDescription = "Gain additional armor as well as improved attack, movement, and reload speed.";
        ...
        abilities[aCount].abilityDescription = "Deploy a self-building turret.";
        ...
        abilities[aCount].abilityDescription = "Create pools of molten slag that damage enemies. Deals additional damage to armor.";
