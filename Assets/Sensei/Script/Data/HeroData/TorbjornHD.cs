...
public class TorbjornHD : HeroData
{
    public TorbjornHD() : base()
    {
        ...
        abilities[aCount].abilityDetails[++bCount] = "<b>Healing:</b> 50 (to Torbjörn's turret)";
        ...
        abilities[aCount].abilityDetails[++bCount] = "\norbjörn's weapon is temporarily replaced by his claw, which shoots out molten slags.";
