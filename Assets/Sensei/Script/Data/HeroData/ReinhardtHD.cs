...
public class ReinhardtHD : HeroData
{
    public ReinhardtHD() : base()
    {
        ...
        abilities[aCount].abilityDescription = "Devastating melee weapon.";
        ...
        abilities[aCount].abilityDescription = "Hold Secondary Fire to deploy a frontal energy barrier.";
        ...
        abilities[aCount].abilityDescription = "Charge forward and smash an enemy against a wall.";
        ...
        abilities[aCount].abilityDescription = "Launch a fiery projectile.";
        ...
        abilities[aCount].abilityDescription = "Knock down all enemies in front of you.";
