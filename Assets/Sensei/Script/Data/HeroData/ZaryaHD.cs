...
public class ZaryaHD : HeroData
{
    public ZaryaHD() : base()
    {
        ...
        abilities[aCount].abilityDetails[bCount = 0] = "Damage:75 per second (at 0%)\n       170 per second(at 100 %)";
        abilities[aCount].abilityDetails[++bCount] = "Max. range:15 meters";
        abilities[aCount].abilityDetails[++bCount] = "Area of effect:0.15 meter beam width";
        ...
        abilities[aCount].abilityDetails[bCount = 0] = "Damage:Enemy: 9.4-47 (at 0%)\n        Enemy: 19 - 95(at 100 %)\n        Self: 4.7 - 23.5(at 0 %)\n        Self: 9.5 - 47.5(at 100 %)";
        ...
        abilities[aCount].abilityDetails[++bCount] = "Ammo:100";
        abilities[aCount].abilityDetails[++bCount] = "Ammo usage:25 rounds per shot";
        abilities[aCount].abilityDetails[++bCount] = "Reload time:1.5 seconds animation";
        abilities[aCount].abilityDetails[++bCount] = "Casting time:instantly + 0.48 s. recovery for primary fire";
        abilities[aCount].abilityDetails[++bCount] = "Headshot:?";
        ...
        abilities[aCount].abilityDetails[++bCount] = "Projected Barrier behaves identically to Particle Barrier. For more ability details, see Particle Barrier.";
        abilities[aCount].abilityDetails[++bCount] = "Although the barrier prevents the target from being Ability Sombra Hack.png hacked, slept, or stunned in the first place, it does not interrupt those effects once already applied.";
        abilities[aCount].abilityDetails[++bCount] = "Projected Barrier unfreezes frozen targets.";
        ...
        abilities[aCount].abilityDetails[++bCount] = "Zarya gains 0.2% Energy per damage blocked by the barrier, or 1% Energy per 5 damage blocked.";
        abilities[aCount].abilityDetails[++bCount] = "The barrier cleanses Zarya of most status and damage over time effects.";
        abilities[aCount].abilityDetails[++bCount] = "While the barrier is up, Zarya is immune to all damage and most Crowd Control effects, even if the attack pierces barriers such as Rocket punch.png Rocket Punch.";
        abilities[aCount].abilityDetails[++bCount] = "Does not protect Zarya from knockback.";
        abilities[aCount].abilityDetails[++bCount] = "Even if the barrier is destroyed, it will protect Zarya from the attack.";
        ...
        abilities[aCount].abilityDetails = new string[7];
        abilities[aCount].abilityDetails[bCount = 0] = "Damage:Impact: 5\n        Damage over time: 5 per second, up to 18.72";
        abilities[aCount].abilityDetails[++bCount] = "Projectile speed:25 meters per second";
        abilities[aCount].abilityDetails[++bCount] = "Area of effect:6 meter radius (gravity)\n              0.2 meter radius(projectile)";
        ...
        abilities[aCount].abilityDetails[++bCount] = "Most movement abilities are disabled within the effect of Graviton Surge.\n - Exceptions: Reaper's Ability-reaper2.png Wraith Form and Moira's Ability Moira Fade.png Fade.";
        ...
        abilities[aCount].abilityDetails[++bCount] = "Energy decays at a rate of 1.8% per second.";
        abilities[aCount].abilityDetails[++bCount] = "Energy instantly resets to 0 upon death. (Resurrect does not restore Energy.)";
        abilities[aCount].abilityDetails[++bCount] = "The more Energy Zarya has, the brighter she glows.";
        abilities[aCount].abilityDetails[++bCount] = "50% or higher is considered 'High Energy.'";
