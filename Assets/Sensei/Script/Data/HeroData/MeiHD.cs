...
public class MeiHD : HeroData
{
    public MeiHD() : base()
    {
        ...
        abilities[aCount].abilityDescription = "Short-range spray weapon that freezes.";
        ...
        abilities[aCount].abilityDescription = "Long-range icicle launcher.";
        abilities[aCount].abilityIcon = "Heroes/AbilityIcons/" + hero + "/EndothermicBlaster";
        abilities[aCount].abilityVideo = hero + "/ability-endothermic-blaster";
        ...
        abilities[aCount].abilityDescription = "Become invulnerable and heal yourself.";
        ...
        abilities[aCount].abilityDescription = "Create a wall in front of you.";
        ...
        abilities[aCount].abilityDescription = "Launch a weather control drone that freezes enemies in a wide area.";
