...
public class WidowmakerHD : HeroData
{
    public WidowmakerHD() : base()
    {
        ...
        abilities[aCount].abilityDescription = "Hold for long-ranged sniper weapon.";
        abilities[aCount].abilityIcon = "Heroes/AbilityIcons/" + hero + "/WidowsKiss";
        ...
        abilities[aCount].abilityDescription = "Launch a poison trap.";
        ...
        abilities[aCount].abilityDescription = "Launch a hook that pulls you towards a ledge.";
        ...
        abilities[aCount].abilityDescription = "Provide your team with a view of the enemy's location.";
