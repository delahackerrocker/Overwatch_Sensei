...
public class CassidyHD : HeroData
{
    public CassidyHD() : base()
    {
        ...
        abilities[aCount].abilityDetails[bCount = 0] = "<b>Damage:</b> 21 - 70";
        ...
        abilities[aCount].abilityDetails[++bCount] = "<b>Rate of Fire:</b> 0.5 second recovery 2 shots per second";
        ...
        abilities[aCount].abilityDetails[bCount = 0] = "<b>Damage:</b> 15 - 50";
        abilities[aCount].abilityDetails[++bCount] = "<b>Falloff Range:</b> 20 to 40 meters";
        abilities[aCount].abilityDetails[++bCount] = "<b>Spread Angle:</b> Constant: 6.50 degrees";
        abilities[aCount].abilityDetails[++bCount] = "<b>Rate of Fire:</b> 1 shot per 0.13 seconds";
        abilities[aCount].abilityDetails[++bCount] = "<b>Ammo:</b> 6";
        abilities[aCount].abilityDetails[++bCount] = "<b>Ammo Usage:</b> up to 6";
        abilities[aCount].abilityDetails[++bCount] = "<b>Reload Time:</b> 1.5 seconds animation";
        abilities[aCount].abilityDetails[++bCount] = "<b>Headshot:</b> Yes";
        ...
        abilities[aCount].abilityDetails[++bCount] = "<b>Duration:</b> 0.8 second stun";
        ...
        abilities[aCount].abilityDetails[bCount = 0] = "<b>Damage:</b> 0.2 to 1.0 seconds: 100 per second; 80 overall";
        ...
        abilities[aCount].abilityDetails[++bCount] = "<b>Move. Speed:</b> -70% penalty";
        abilities[aCount].abilityDetails[++bCount] = "<b>Max Range:</b> 200 meters";
        abilities[aCount].abilityDetails[++bCount] = "<b>Rate of Fire:</b> 1 shot per 0.2 seconds";
        abilities[aCount].abilityDetails[++bCount] = "<b>Ammo Usage:</b> 1 per target";
        abilities[aCount].abilityDetails[++bCount] = "<b>Casting Time:</b> instantly";
        abilities[aCount].abilityDetails[++bCount] = "<b>Duration:</b> 0.29 s. min. duration";
