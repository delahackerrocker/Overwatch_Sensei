...
public class PharahHD : HeroData
{
    public PharahHD() : base()
    {
        ...
        abilities[aCount].abilityDetails[++bCount] = "Projectile speed:35 meters per second";
        abilities[aCount].abilityDetails[++bCount] = "Area of effect:2.5 meter radius (explosion)\n             0.2 meter radius(projectile)";
        abilities[aCount].abilityDetails[++bCount] = "Rate of fire:1 shot per 0.85 seconds\n             extra delay while using meleee";
        ...
        abilities[aCount].abilityDetails[++bCount] = "Explosive Damage and knockback decreases with distance from the explosion, reaching 0% at the edge of the blast radius.";
        abilities[aCount].abilityDetails[++bCount] = "Explosive Damage and knockback also applies to self.";
        ...
        abilities[aCount].abilityDetails[bCount = 0] = "Move. speed:+20% buff\n          4.27 meters per second (vertically)";
        abilities[aCount].abilityDetails[++bCount] = "Duration:Up to 2 seconds";
        abilities[aCount].abilityDetails[++bCount] = "Activated by holding jump button while in the air, or alt-fire button.";
        abilities[aCount].abilityDetails[++bCount] = "Allows Pharah to gain height when held. When held for 2 seconds, Pharah gains more than 8 meters vertical height.";
        abilities[aCount].abilityDetails[++bCount] = "Refuels 43% per second automatically when not in use, taking ~2.33 seconds to refill from empty to full.";
        ...
        abilities[aCount].abilityDetails[bCount = 0] = "Damage:Knockback";
        ...
        abilities[aCount].abilityDetails[++bCount] = "Casting time:0.16 seconds for throw + 0.5 seconds recovery for shoot";
        abilities[aCount].abilityDetails[++bCount] = "Cooldown:9 seconds";
        abilities[aCount].abilityDetails[++bCount] = "Headshot:?";
        abilities[aCount].abilityDetails[++bCount] = "During cast time, you can change the future flight path.";
        abilities[aCount].abilityDetails[++bCount] = "If the ability is interrupted before the end of the casting time, the cooldown will not start.";
        abilities[aCount].abilityDetails[++bCount] = "Also knocks back Pharah herself.";
        abilities[aCount].abilityDetails[++bCount] = "Can be used as an additional mobility tool, as it does not deal self damage.";
        abilities[aCount].abilityDetails[++bCount] = "Mostly deals horizontal knockback.";
        ...
        abilities[aCount].abilityDetails = new string[7];
        abilities[aCount].abilityDetails[bCount = 0] = "Max. range:11.55 meters vertically";
        abilities[aCount].abilityDetails[++bCount] = "Duration:0.496 seconds";
        ...
        abilities[aCount].abilityDetails[++bCount] = "The stun does not interrupt the ability.";
        ...
        abilities[aCount].abilityDetails[bCount = 0] = "Damage:Direct hit: 40\n       Splash: 9 - 30\n       Self: 4.5 - 15";
        abilities[aCount].abilityDetails[++bCount] = "Move. speed:Caster immobilized";
        ...
        abilities[aCount].abilityDetails[++bCount] = "Rate of fire:30 rockets per second";
        abilities[aCount].abilityDetails[++bCount] = "Duration:2.5 seconds";
        abilities[aCount].abilityDetails[++bCount] = "Headshot:?";
        abilities[aCount].abilityDetails[++bCount] = "Ultimate cost:2100 points";
        abilities[aCount].abilityDetails[++bCount] = "Pharah remains stationary while the ability is active, but can turn.";
        abilities[aCount].abilityDetails[++bCount] = "Pharah will stay in the air if the ability is used mid-air.";
        abilities[aCount].abilityDetails[++bCount] = "Restores Rocket Launcher ammo after the ability ends, provided the ability wasn't canceled prematurely.";
        abilities[aCount].abilityDetails[++bCount] = "A total of 675 - 3000 damage can be dealt to enemies using the ultimate.";
        abilities[aCount].abilityDetails[++bCount] = "A total of 337.5 - 1125 self-damage can be dealt through the ultimate.";
