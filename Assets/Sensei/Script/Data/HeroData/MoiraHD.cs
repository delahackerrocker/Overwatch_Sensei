...
public class MoiraHD : HeroData
{
    public MoiraHD() : base()
    {
        ...
        abilities[aCount].abilityDetail = "Hold to heal all allies in front of you. Consumes biotic energy.";
        ...
        abilities[aCount].abilityDetail = "Long range beam weapon. Damage dealt heals you and replenishes your biotic energy.";
        abilities[aCount].abilityIcon = "Heroes/AbilityIcons/" + hero + "/BioticGrasp";
        abilities[aCount].abilityVideo = hero + "/ability-biotic-grasp";
        ...
        abilities[aCount].abilityDetail = "Disappear, move faster, and become invulnerable, but you cannot shoot.";
        ...
        abilities[aCount].abilityDetail = "Launch a bouncing sphere that either heals nearby allies or damages nearby enemies.";
        ...
        abilities[aCount].abilityDetail = "Fire a beam that heals allies and damages enemies.";
