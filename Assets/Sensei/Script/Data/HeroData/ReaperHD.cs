...
public class ReaperHD : HeroData
{
    public ReaperHD() : base()
    {
        ...
        abilities[aCount].abilityDetail = "Short-range spread weapons.";
        ...
        abilities[aCount].abilityDetail = "Move faster and become invulnerable, but you cannot shoot.";
        ...
        abilities[aCount].abilityDetail = "Teleport to a targeted location.";
        ...
        abilities[aCount].abilityDetail = "Dealing damage heals you.";
        ...
        abilities[aCount].abilityDetail = "Damage all nearby enemies.";
